...
var LatexSuitePlugin = class extends import_obsidian2.Plugin {
  constructor() {
    super(...arguments);
    ...
    this.onKeydown = (event, view) => {
      const markdownView = view.state.field(import_obsidian2.editorViewField, false);
      if (!markdownView)
        return;
    ...
    this.expandSnippet = (view, start, end, replacement) => {
